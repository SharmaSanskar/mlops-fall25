...
## Additional Demo DAG
As an additional exercise, a simple demonstration DAG (`demo_dag.py`) has been created to showcase basic Airflow functionality:
- **Python Operators**: Hello, date printing, calculations, and goodbye tasks
- **Bash Operator**: Simple bash command execution
- **Linear Workflow**: Tasks execute sequentially with clear dependencies
- **Scheduled Execution**: Runs every hour with proper logging
